...
- Stress Calculations:
  ...
  - where $\bar{\mathbf{a}}_{\alpha}=\mathbf{\bar{F}}\cdot\mathbf{A}_{\alpha},\quad\bar{\mathbf{a}}_{\beta}'=\bar{\mathbf{a}}_{\beta}\cdot\mathbf{\bar{b}},\quad\text{and}\quad\bar{\mathbf{a}}_{\alpha}'=\mathbf{\bar{b}}\cdot\bar{\mathbf{a}}_{\alpha},$
